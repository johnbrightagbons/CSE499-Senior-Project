...
The goal is to create a dynamic frontend web application that demonstrates strong JavaScript skills, responsive design, and best practices in usability.
...
• Simple charts showing spending by category (using JavaScript)
• Monthly filtering
